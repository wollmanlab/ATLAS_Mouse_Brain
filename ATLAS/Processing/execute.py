#!/usr/bin/env python
import argparse
from ATLAS.Processing.Processing import *
from ATLAS.Utils.imageu import *
import time
import gc
"""
conda activate ATLAS_3.9; nice -n 10 nohup python -W ignore /home/zach/PythonRepos/ATLAS/ATLAS/Processing/execute.py /orangedata/Images2023/Gaby/ATLAS/Acrydite_77.5.A_DPNMF_97.5.B_2023Feb16/ -c ATLAS_processing_config_v1 -w A; conda deactivate
"""
if __name__ == '__main__':
    ...
    parser.add_argument("-c","--cword_config", type=str,dest="cword_config",default='ATLAS_processing_config_tree', action='store',help="Name of Config File for analysis ie. ATLAS_processing_config")
...
if __name__ == '__main__':
    """
     Main Executable to process raw Images to ATLAS data
    """
    ...
    while np.sum(completion_array==False)>0:
        ...
        for idx,section in enumerate(sections):
            gc.collect()
            self = Processing_Class(metadata_path,section,cword_config,verbose=True)
