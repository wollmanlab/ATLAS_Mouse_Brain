...
from ATLAS.Utils import imageu
...
class Processing_Class(object):
    """
    Processing_Class Primary Class to Process ATLAS Sections
    """
    def __init__(self,
                 metadata_path,
                 section,
    ...
    def main(self):
        """
        run Primary Function to Process ATLAS Sections
        """
        self.setup_output()
        self.load_metadata()
