...
input_X_path  = '/greendata/GeneralStorage/fangming/projects/ATLAS/res_dpnmf/v_python/inputs/smrt_withrep_X_subL5n100.npy'
output_w_path_format = '/greendata/GeneralStorage/fangming/projects/ATLAS/res_dpnmf/v_python/output_demo/TreeDPNMF_smrt_mu{}.npy' # left out the parameter mu
logging.info(f"{input_X_path} -> \n" + f"{output_w_path_format}")
cell_path     = '/greendata/GeneralStorage/fangming/projects/ATLAS/res_dpnmf/v_python/inputs/smrt_withrep_X_subL5n100_cells.csv'
meta_path     = '/greendata/GeneralStorage/fangming/projects/ATLAS/data/rna/scrna_ss_ctxhippo_a_exon_DPNMF_genes_matrix.h5ad'
