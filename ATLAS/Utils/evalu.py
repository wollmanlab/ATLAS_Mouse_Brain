...
class Level3Res:
    def __init__(self, meta, levels, 
                 ...
                 refdata_name='scRNA-seq', data_name='ATLAS',
...
def plot_validation_genes_level3(Xmat, Ymat, splitat, splitat_v, xtitle='scRNA-seq', ytitle='ATLAS',
...
def plot_validation_genes_level3_expand(Ymat, clst_sizes, splitat_v, ylabel='ATLAS'):
    """
    """
